...
public class Repositioning {
    ...
    public void doAngleRepositioning(DcMotor pFrontLeft, DcMotor pFrontRight, DcMotor pBackLeft, DcMotor pBackRight, NavigationHelper pNavigate, BNO055IMU pImu, Telemetry pTelemetry, Boolean isBlue, Servo repositioningRight, Servo repositioningLeft) {
        ...
        /*pNavigate.navigate(0, Constants12907.Direction.TURN,30,0.4,pBackLeft,pBackRight,pFrontRight,pFrontLeft,pImu,pTelemetry);
        ...
        */
        ...
        turnWithEncoders(pFrontRight,pFrontLeft, pBackRight,pBackLeft, 30, 0.5, pImu,pTelemetry);
        ...
        //pNavigate.navigate(26, Constants12907.Direction.RIGHT,0,0.4,pBackLeft,pBackRight,pFrontRight,pFrontLeft,pImu,pTelemetry);
