...
public class NavigationTester extends LinearOpMode {
    ...
    public void runOpMode() throws InterruptedException {
        ...
        if(opModeIsActive()) {
            ...
            navigateTest.navigate(0, Constants12907.Direction.TURN, 90, 0.25, backLeft, backRight, frontRight, frontLeft, imu, telemetry);
            //navigateTest.navigate(40, Constants12907.Direction.STRAIGHT, 0, 0.25, backLeft, backRight, frontRight, frontLeft, pImu, telemetry);
