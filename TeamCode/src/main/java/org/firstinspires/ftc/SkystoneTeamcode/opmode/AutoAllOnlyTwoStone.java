...
public class AutoAllOnlyTwoStone extends LinearOpMode {
...
*/
    ...
    private void twoStonePlaceMethod(double direction){
        ...
        navigate(currentFoundationDistance1+1,Constants12907.Direction.LEFT,0,0.9,false);
