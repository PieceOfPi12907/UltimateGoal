...
//heloooooo its me i was wondering...
        ...
        if (position.equals(Constants2020.TargetZone.ALPHA)) {
            if (isBlue && !isWall) {
               ...
               //shooting rings - get into position
               navigater.navigate(27, Constants12907.Direction.LEFT, 0, 0.5, backLeft, backRight, frontRight, frontLeft, imu, telemetry, true);
               navigater.navigate(-13, Constants12907.Direction.STRAIGHT, 0, -0.5, backLeft, backRight, frontRight, frontLeft, imu, telemetry, true);
            ...
            if (!isWall) {
                //Red Not Wall (shooting rings)
                navigater.navigate(-34, Constants12907.Direction.STRAIGHT, 0, -0.4, backLeft, backRight, frontRight, frontLeft, imu, telemetry, true);
            ...
            if (isWall) {
                ...
                //shooting rings - get into position
                navigater.navigate(27, Constants12907.Direction.LEFT, 0, 0.5, backLeft, backRight, frontRight, frontLeft, imu, telemetry, true);
                navigater.navigate(-56, Constants12907.Direction.STRAIGHT, 0, -0.5, backLeft, backRight, frontRight, frontLeft, imu, telemetry, true);
